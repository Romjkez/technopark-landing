...
<header class="container-fluid headerWrapper h-100">
    ...
    <div class="btnBlock col-12 col-lg-6 offset-lg-3 d-flex justify-content-around flex-wrap"><a
                class="scrollToActivities text-center" href="#activities">Подробнее</a>
...
<main class="container-fluid">
    ...
    <div class="row">
        <div class="childrenTechnopark col-xl-5 offset-xl-1 col-xxl-4 col-12 offset-xxl-2 offset-0"><h2
            ...
            <p>- это инженерно-технологический комплекс, на базе которого проводятся углубленные технико-ориентированные
                курсы дополнительного образования для школьников.</p></div>
    </div>
    <div class="row">
        <div class="photoGallery col-12 text-center"><a href="assets/img/4.jpg" data-fancybox="gallery"
    ...
    <div class="row">
        ...
        <div class="description col-sm-6 offset-sm-0 col-xl-6 offset-xl-1 offset-xxl-1 col-xxl-4"><h2
                    class="font-weight-bold">ДЕТСКИЙ ТЕХНОПАРК</h2>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-xl">
        <div class="modal-content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="leftPart col-lg-6 d-flex flex-column">
                            <div class="textBlock"><h6>В преддверии самого сказочного времени года<br>Детский технопарк
                                    ЦРИ приглашает Вас на</h6><h5 class="font-weight-bold">НОВОГОДНИЕ МАСТЕР-КЛАССЫ:
                                    "СКАЗОЧНАЯ ЕЛКА"</h5></div>
                            <div class="imgBlock text-center d-flex align-items-center justify-content-center"><h5>
                                    ПРИЯТНО, КОГДА РЕБЕНОК МОЖЕТ СДЕЛАТЬ<br>ПОДАРОК ДЛЯ БЛИЗКИХ СВОИМИ РУКАМИ.</h5>
                            </div>
                        </div>
                        <div class="rightPart col-lg-6">
                            <div class="textBlock"><h6>Стоимость: <span>500 рублей на человека</span><br>При покупке 2
                                    мастер-классов стоимость: <span>900 рублей</span><br>Группа:
                                    <span>от 7 человек</span><br>Продолжительность мастер-класса: <span>от 45 мин до 2 часов</span><br>Максимальное
                                    количество человек в группе: <span>20</span><br>Время проведения мастер-класса
                                    <span>выбираете ВЫ</span></h6></div>
                            <div class="serviceBlock d-flex"><img class="d-block" src="assets/img/napravleniya.png"
                                                                  alt="Направления">
                                <div class="serviceBlock__content d-flex align-items-center"><p class="d-block">-
                                        Ниткография<br>- Выжигание<br>- Валяние<br>- Вязание<br>- Декупаж<br>- Рисование<br>-
                                        Лепка из пластилина<br>- Картина из гвоздей и ниток<br>- Новогодние декоративные
                                        магниты<br>- Декорирование новогодних колпаков<br>- Игрушки из фетра</p></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <div class="container-fluid">
                    <div class="row"><img src="assets/img/paintTool.svg" alt="">
